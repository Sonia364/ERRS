...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="images/AV-logo-main.png" />
                ...
                <div class="container">
                    <div class="uni-medicare-header-main">
                        ...
                        <div class="wrapper-logo">
                            <a class="logo-default" href="#"><img src="images/AV-logo-main.png" alt="" width="60px" class="img-responsive"></a>
                            <div class="clearfix"></div>
                        </div>
                    ...
                    <div class="uni-owl-one-item owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="content animated" data-animation="flipInX" data-delay="0.9s">
                                <div class="container">
                                    <div class="caption">
                                        <h1>Emergency Response and Reporting System</h1>
                ...
                <div class="container">
                    <div class="copyright-content">
                        <div class="row">
                            ...
                            <div class="col-sm-6 ">
                               <p class="copyright-text text-end"> <a href="#">By Autonomous Vehiculum</a></p>
                            </div>
                        </div>
                    </div>
                </div>

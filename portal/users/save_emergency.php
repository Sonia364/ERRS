...
$sql = "INSERT INTO emergency (`emergency_id`,`agency_id`,`case_severity`,`emergency_category`,`phone_number`,`address`,`name`,`state`,`status`,`victim_id`,`dates`,`email`,`description`) VALUES (:a,:b,:c,:d,:e,:f,:g,:h,:i,:j,:k,:l,:m)";
$q = $db->prepare($sql);
$q->bindParam(':a', $a);
$q->bindParam(':b', $b);
$q->bindParam(':c', $c);

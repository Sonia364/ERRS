            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <?php
                        // include('../connect.php');
                        $result = $db->prepare("SELECT count(*) as total FROM emergency WHERE agency_id = {$_SESSION['SESS_AGENCY_ID']} AND status = 'Pending'  ORDER BY id DESC  ");
                        $result->execute();
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Agency</label>
                            <input type="text" class="form-control" value="<?php echo $_SESSION['SESS_FIRST_NAME'] ?>" id="agency" name="agency" readonly>
                    ...
                    <div class="col-md-12">
                        <div class="table-responsive print-table">
                            <table class="table table-border table-striped custom-table datatable mb-0" id="myTable">
                                ...
                                <tbody>
                                <?php
                                    $result = $db->prepare("SELECT e.*, a.agency_name FROM emergency e INNER JOIN agency a ON e.agency_id = a.agency_id WHERE e.agency_id = {$_SESSION['SESS_AGENCY_ID']} ORDER BY e.id DESC");
                                    $result->execute();
